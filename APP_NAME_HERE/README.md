...
- ACCOUNT_ID_HERE
- TABLE_NAME_HERE
- APP_NAME_HERE (don't forget the name of the directory as well)


- start here https://serverless-stack.com/chapters/create-an-aws-account.html and continue on until here https://serverless-stack.com/chapters/add-support-for-es6-es7-javascript.html
- run ```serverless deploy``` in the working server directory
- continue here https://serverless-stack.com/chapters/create-a-cognito-identity-pool.html
- to set up the front end continue here https://serverless-stack.com/chapters/create-a-new-reactjs-app.html
